...
💬 Чтобы ответить:
• Нажмите кнопку "Написать напрямую" для прямого чата
• Или используйте команду: /dm ${requestData.userId} Ваш ответ
`;
...
Важное обновление: теперь вы можете общаться с пользователями через ваш личный аккаунт Telegram, нажав на кнопку "Написать напрямую".`);
...
Важное обновление: теперь у вас есть кнопка "Написать напрямую", которая позволяет общаться с пользователями через ваш личный аккаунт Telegram.
